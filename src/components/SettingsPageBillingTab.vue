<template>
	<div id="app">
					...
					<div class="grid-item">
						...
						<div v-if="this.customerDefaultSource !== null" class="default-source">
							<div class="change-preference">
								<router-link class="nav-link" to="/dashboard/changeDefaultSource">
									Change Preference
								</router-link>
							</div>
							<br>
							<div class="default-payment-card">
								...
								<pre>{{ this.customerDefaultSource.brand }} ending in	{{ this.customerDefaultSource.last4 }} </pre> <pre> expires : {{ this.customerDefaultSource.exp_month }} / {{ this.customerDefaultSource.exp_year }}</pre>
							</div>
						</div>
						...
						<br><br>
							<button type="button" class="add-payment-button" @click="addPaymentMethod">
								<span class="glyphicon glyphicon-plus-sign"><strong>Add Card</strong></span>
							</button>
					</div>					
			...
			<div id="subscriptions-billing-tab" v-for="subscription in this.subscriptions" v-bind:key="subscription">
